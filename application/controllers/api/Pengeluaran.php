...
class Pengeluaran extends RestController
{
    public function index_post(){
        ...
        if($insert){
            ...
            $this->response([
                'status' => false,
                'message' => 'Pengeluaran belum tersimpan, ulangi lagi!'
            ],404);
        }
    }
    ...
    public function index_get(){
        ...
        $get_pendapatan = $this->db->get_where('pengeluaran', $where)->result_array();
        if($get_pendapatan){
            foreach ($get_pendapatan as $key => $value) {
                $arrDataPendapatan[] = [
                    'id_pengeluaran' => $value['id_pengeluaran'],
    ...
    public function hapus_get(){
        $id_pengeluaran = $this->get('id_pengeluaran');
        $this->db->where('id_pengeluaran', $id_pengeluaran);
    ...
    public function grafik_get(){
        ...
        if($status == 'previous'){
            ...
            $get_januari = $this->db->get_where('pengeluaran', $where1)->result_array();
            $total_januari = 0;
            if($get_januari){
            ...
            $get_februari = $this->db->get_where('pengeluaran', $where2)->result_array();
            $total_februari = 0;
            if($get_februari){
            ...
            $get_maret = $this->db->get_where('pengeluaran', $where3)->result_array();
            $total_maret = 0;
            if($get_maret){
            ...
            $get_april = $this->db->get_where('pengeluaran', $where4)->result_array();
            $total_april = 0;
            if($get_april){
            ...
            $get_mei = $this->db->get_where('pengeluaran', $where5)->result_array();
            $total_mei = 0;
            if($get_mei){
            ...
            $get_juni = $this->db->get_where('pengeluaran', $where6)->result_array();
            $total_juni = 0;
            if($get_juni){
            ...
            $get_juli = $this->db->get_where('pengeluaran', $where1)->result_array();
            $total_juli = 0;
            if($get_juli){
            ...
            $get_agustus = $this->db->get_where('pengeluaran', $where2)->result_array();
            $total_agustus = 0;
            if($get_agustus){
            ...
            $get_september = $this->db->get_where('pengeluaran', $where3)->result_array();
            $total_september = 0;
            if($get_september){
            ...
            $get_oktober = $this->db->get_where('pengeluaran', $where4)->result_array();
            $total_oktober = 0;
            if($get_oktober){
            ...
            $get_november = $this->db->get_where('pengeluaran', $where5)->result_array();
            $total_november = 0;
            if($get_november){
            ...
            $get_desember = $this->db->get_where('pengeluaran', $where6)->result_array();
            $total_desember = 0;
            if($get_desember){
