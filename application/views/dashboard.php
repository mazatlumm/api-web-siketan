...
<path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0zm0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13zm8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5zM3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8zm10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0zm-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0zm9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707zM4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708z"/>
    ...
    <div id="btn_tambah_berita" class="add-new-contact-wrap">
      <a class="shadow bg-primary" data-bs-toggle="modal" data-bs-target="#ModalBuatBerita">
      ...
      <div class="container pt-2">
        <div class="card position-relative shadow-sm"><img class="card-img-top" src="<?=base_url()?>upload/berita/<?=$value['tumbnail']?>" alt="">
          <div class="card-body direction-rtl">
            ...
            <p><?=$value['deskripsi']?></p>
            <a class="btn btn-primary" href="<?=base_url()?>berita/detil/<?=$value['id']?>">Selengkapnya</a>
          </div>
        </div>
      </div>
      <?php } ?>
    ...
    <div class="modal fade bottom-align-modal" id="ModalBuatBerita" tabindex="-1" aria-labelledby="ModalBuatBeritaLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="ModalBuatBeritaLabel">Buat Berita</h6>
                    <button class="btn btn-close p-1 ms-auto" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="FormBeritaTeks" action="<?= base_url() ?>api/berita/teks" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_user" id="id_user">    
                    <p style="font-size: 12px; color:black" class="my-0">Banner Ukuran 1000 x 563 px</p>
                        ...
                        <div class="form-group">
                          <p id="info_panjang_karakter" style="font-size: 12px; color:black" class="my-0">Maksimal 300 karakter</p>
                            <textarea onkeyup="HitungKarakterDeskripsi()" type="text" id="deskripsi" name="deskripsi" class="form-control" placeholder="Deskripsi Berita"></textarea>
                        </div>
                        <textarea id="editor" name="content_berita" class="mb-2"></textarea>
      ...
      $( document ).ready(function() {
        ...
        function GetDataUser(){
            ...
            if (typeof(Storage) !== "undefined") {
                ...
                if(DataUser != null){
                  let id_user = JSON.parse(DataUser).id_user
